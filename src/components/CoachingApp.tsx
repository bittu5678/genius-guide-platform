...
import {
  ...
  Eye, EyeOff, FileBarChart, FileText, Gauge, GraduationCap, LayoutDashboard,
...
function StudentDashboard() {
  return <div className="animate-rise space-y-6">
    ...
    <Panel title="Upcoming exams" subtitle="Stay prepared for your next challenges" action="View calendar"><StudentExams /></Panel>
  </div>;
}
